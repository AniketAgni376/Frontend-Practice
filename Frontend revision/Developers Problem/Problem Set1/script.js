// ek button banao and us button ke click par aapko ek user lekar 
// aana hai random tareeke se or use add karna hai dom me .
...
.then(result=>{
    ...
    document.querySelector("#parent").innerHTML+= `<div class="card w-60 p-4 rounded-xl bg-zinc-800">
               ...
               <p class="mt-5 text-xs font-semibold opacity-80">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum, eum.</p>
           </div>`;
})
}
